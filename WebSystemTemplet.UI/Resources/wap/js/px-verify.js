...
var PXVerify = {
	...
	ShowImageVerify : function(phone,forgot,callback){
		var box = $('<div class="send-phone-verify"><h3>请输入验证码<a></a></h3><p><span>验证码：</span><input type="text"/><img title="点击刷新" src="'+DOMIN.MAIN+'/register/vercode""></p><div><span class="err"></span><a></a></div></div>').appendTo('body').css({"z-index":"5001",top:$(window).scrollTop()+$(window).height()/2-80});
